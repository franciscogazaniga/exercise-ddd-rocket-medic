...
export function setupRoutes(
  ...
  const doctorWorkingHoursController = new DoctorWorkingHoursController(doctorWorkingHoursService)
  const doctorSpecialtyController = new DoctorSpecialtyController(doctorSpecialtyService)

  app.use("/api/doctors", doctorController.router)
  app.use("/api/doctors/:id/specialties", doctorSpecialtyController.router)
  app.use("/api/doctors/:id/working-hours", doctorWorkingHoursController.router)
