export class AppointmentService {
  ...
  async execute(appointment) {
    const date = typeof appointment.date === "string" ? new Date(appointment.date) : appointment.date
    ...
    const isDoctorAvailable = this.doctorAvailabilityService.isDoctorAvailable(doctorId, date)
